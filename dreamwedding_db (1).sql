...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Jun 25, 2021 at 07:49 PM
...
DROP TABLE IF EXISTS `otp_status`;
...
CREATE TABLE IF NOT EXISTS `tbl_lifestyle` (
...
DROP TABLE IF EXISTS `tbl_member_qualification`;
CREATE TABLE IF NOT EXISTS `tbl_member_qualification` (
...
CREATE TABLE IF NOT EXISTS `tbl_package_detail` (
...
DROP TABLE IF EXISTS `tbl_send_request`;
CREATE TABLE IF NOT EXISTS `tbl_send_request` (
...
DROP TABLE IF EXISTS `tbl_sub_community`;
CREATE TABLE IF NOT EXISTS `tbl_sub_community` (
