                ...
                <div class="card-body card-dashboard">
                  <div class="table-responsive">
                    <table class="table table-striped dataex-html5-selectors">
                      <thead>
                        <tr>
                          <th>Member_Detail_ID</th>
                          <th>Member_ID</th>
                          <th>Member_Sub_Community_ID</th>
                          <th>Member_Religion</th>
                          <th>Language_ID</th>
                          <th>Member_With_Family</th>
                          <th>Member_Childrens</th>
                          <th>Member_Height</th>
                          <th>Member_Weight</th>
                          <th>Caste_No_Bar</th>
                          <th>Marital_Status</th>
                          <th>Member_Birthplace</th>
                          <th>Member_Body_Type</th>
                          <th>Member_Complexion</th>
                          <th>Member_Rashi</th>
                        </tr>
                      </thead>
                      <tbody>
                        <?php 
                          $query="select * from tbl_member_detail ";
                          $display= mysqli_query($conn, $query) or die(mysqli_error($conn));
                          while ($row=mysqli_fetch_array($display)){
                          ?>
                          <tr>
                            <td><?php echo $row['Member_Detail_ID'];?></td>
                            <td><?php echo $row['Member_ID'];?></td>
                            <td><?php echo $row['Member_Sub_Community_ID'];?></td>
                            <td><?php echo $row['Member_Religion'];?></td>
                            <td><?php echo $row['Language_ID'];?></td>
                            <td><?php echo $row['Member_With_Family'];?></td>
                            <td><?php echo $row['Member_Childrens'];?></td>
                            <td><?php echo $row['Member_Height'];?></td>
                            <td><?php echo $row['Member_Weight'];?></td>
                            <td><?php echo $row['Caste_No_Bar'];?></td>
                            <td><?php echo $row['Marital_Status'];?></td>
                            <td><?php echo $row['Member_Birthplace'];?></td>
                            <td><?php echo $row['Member_Body_Type'];?></td>
                            <td><?php echo $row['Member_Complexion'];?></td>
                            <td><?php echo $row['Member_Rashi'];?></td>
                          </tr>
                          <?php } ?>
                      </tfoot>
                    </table>
