...
<?php 
	...
	{
		$str="select * from tbl_member where Member_Email='".$_POST['email']."' and Member_Password='".$_POST['passwd']."'";	
            ...
            <div class="row">
                <div class="hom-nav">
                    ...
                    <div class="logo">
                        ...
                        <a href="index.php" class="logo-brand"><img src="images/logo-b.png" alt="" loading="lazy"
                                class="ic-logo"></a>
                    </div>
                                            ...
                                            <ul>
                                                <li>
                                                    <div class="menu-box menu-box-2">
                                                        ...
                                                        <a href="all-profiles.php" class="fclick"></a>
                                                    </div>
                                                </li>
                                                <li>
                                                    <div class="menu-box menu-box-1">
                                                        ...
                                                        <span class="explor-cta">More details</span>
                                                        <a href="wedding.php" class="fclick"></a>
                                                    </div>
                                                </li>
                                                <li>
                                                    <div class="menu-box menu-box-3">
                                                        ...
                                                        <span class="explor-cta">More details</span>
                                                        <a href="services.php" class="fclick"></a>
                                                    </div>
                                                </li>
                                                <li>
                                                    <div class="menu-box menu-box-4">
                                                        ...
                                                        <span class="explor-cta">More details</span>
                                                        <a href="plans.php" class="fclick"></a>
                                                    </div>
                                                </li>
                                            </ul>
                                        </div>
                                ...
                                <div class="smenu-open smenu-multi">
                                    <div class="container">
                                            ...
                                            <div class="multi-col">
                                                <div class="inn">
                                                    ...
                                                    <ul>
                                                        ...
                                                        <li><a href="faq.php">FAQ</a></li>
                                                        <li><a href="coming-soon.php" target="_blank">Coming soon</a>
                                                        </li>
                                        ...
                                        <ul>
                                            ...
                                            <li><a href="user-interests.php">Interests</a></li>
                                            <li><a href="user-chat.php">Chat lists</a></li>
                                            <li><a href="user-plan.php">My plan details</a></li>
                                            <li><a href="user-setting.php">Profile settings</a></li>
                                            <li><a href="user-profile-edit.php">Edit full profile</a></li>
