								...
								<table class="table dataex-html5-selectors" id="myTable">
									...
									<tbody>
										<?php
											...
											$str="select * from member_detail_tbl,member_tbl,sub_community_tbl,language_tbl 
												  where member_detail_tbl.member_id=member_tbl.member_id and 
												  member_detail_tbl.member_sub_community_id=sub_community_tbl.sub_community_id and  
												  member_detail_tbl.language_id=language_tbl.language_id  
										...
										?>
												<tr>
													<td><?php echo $data['member_detail_id']; ?></td>
													<td style="width:18%">
														<button type="button" style="" id="user" class="btn" data-id="<?php echo $data['member_id'];?>" data-toggle="modal" data-target=".bs-example-modal-lg" onclick="Member_Modal( <?php echo $data['member_id']; ?> )">
															<i class="bx bxs-info-circle" style="font-size:18px;color:grey"></i> <?php echo $data['member_lastname']?> <?php echo $data['member_firstname']; ?>
														</button>
													</td>
													<td><?php echo $data['member_religion']; ?></td>
													<td><?php echo $data['marital_status']; ?></td>
													<td><?php echo $data['member_birthplace']; ?></td>
													<td><?php echo $data['member_rashi']; ?></td>
												</tr>
										<?php		  
											}
										?>
