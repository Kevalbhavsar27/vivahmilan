<div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
      ...
      <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation" data-icon-style="">
          <li class=" nav-item"><a href="index.php"><i class="bx bx-home-alt"></i><span class="menu-title text-truncate" data-i18n="Dashboard">Dashboard</span><span class="badge badge-light-danger badge-pill badge-round float-right mr-50 ml-auto">2</span></a>
            <ul class="menu-content">
              <li><a class="d-flex align-items-center" href="dashboard-ecommerce.php"><i class="bx bx-right-arrow-alt"></i><span class="menu-item text-truncate" data-i18n="eCommerce">Main-dashboard</span></a>
              </li>
              <li class="active"><a class="d-flex align-items-center" href="dashboard-analytics.php"><i class="bx bx-right-arrow-alt"></i><span class="menu-item text-truncate" data-i18n="Analytics">Analytics</span></a>
              </li>
            </ul>
          </li>
          ...
          <li class=" nav-item"><a href="#"><i class="bx bx-file"></i><span class="menu-title text-truncate" data-i18n="Invoice">Sub-Community</span></a>
         <ul class="menu-content">
              <li><a class="d-flex align-items-center" href="subcommunity_list.php"><i class="bx bx-right-arrow-alt"></i><span class="menu-item text-truncate" data-i18n="Invoice list">Sub-Community_list</span></a>
              </li>
          ...
          <li class=" nav-item"><a href="#"><i class='bx bxs-package'></i><span class="menu-title text-truncate" data-i18n="Invoice">Package</span></a>
            <ul class="menu-content">
              <li><a class="d-flex align-items-center" href="package_list.php"><i class="bx bx-right-arrow-alt"></i><span class="menu-item text-truncate" data-i18n="Invoice List">Package_list</span></a>
              </li>
          ...
          <ul class="menu-content">
              ...
              <li><a class="d-flex  align-items-center" href="member_details.php"><i class="bx bx-right-arrow-alt"></i><span class="menu-item text-truncate" data-i18n="Invoice List">Member_detail</span></a>
              </li>
              <li><a class="d-flex  align-items-center" href="member_qualification.php"><i class="bx bx-right-arrow-alt"></i><span class="menu-item text-truncate" data-i18n="Invoice List">Member_qualification</span></a>
              </li>
            </ul>
          </li>
          <li class=" nav-item"><a href="states.php"><i class="bx bx-user-plus"></i><span class="menu-title text-truncate" data-i18n="Calendar">States</span></a>
          <ul class="menu-content">
        ...
        <li class=" nav-item"><a href="states.php"><i class="bx bx-user-plus"></i><span class="menu-title text-truncate" data-i18n="Calendar">Citys</span></a>
          <ul class="menu-content">
          ...
          <li class=" nav-item"><a href="testimonial.php"><i class="bx bx-chat"></i><span class="menu-title text-truncate" data-i18n="Chat">Testimonial</span></a>
          </li>
          
          <li class=" nav-item"><a href="faqadd.php"><i class="bx bx-chat"></i><span class="menu-title text-truncate" data-i18n="Chat">Faq</span></a>
          <ul class="menu-content">
              <li><a class="d-flex  align-items-center" href="faq_list.php"><i class="bx bx-right-arrow-alt"></i><span class="menu-item text-truncate" data-i18n="Invoice List">FAQ_List</span></a>
              </li>
            </ul>
          </li>
          ...
          <li class=" nav-item"><a href="#"><i class="bx bx-user-plus"></i><span class="menu-title text-truncate" data-i18n="Calendar">Send-request</span></a>
          <ul class="menu-content">
              </li>
              <li><a class="d-flex  align-items-center" href="send_request.php"><i class="bx bx-right-arrow-alt"></i><span class="menu-item text-truncate" data-i18n="Invoice List">send_request-List</span></a>
              </li>
            </ul>  
        </li>
        <li class=" nav-item"><a href="#"><i class="bx bx-chat"></i><span class="menu-title text-truncate" data-i18n="Chat">Lifestyle</span></a>
          <ul class="menu-content">
