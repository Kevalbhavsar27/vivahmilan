            ...
            <div class="breadcrumbs-top">
              ...
              <div class="breadcrumb-wrapper d-none d-sm-block">
                <ol class="breadcrumb p-0 mb-0 pl-1">
                  ...
                  <li class="breadcrumb-item"><a href="#">tbl_package_detail</a>
                  </li>
                    ...
                    <table class="table table-striped dataex-html5-selectors">
                      <thead>
                        <tr>
                          ...
                          <th>BloodGroup</th>
                          <th>Hobbies_Intrest</th>
                          <th>Member_Diet</th>
                          <th>Languages_Known</th>
                          <th>Residential_Status</th>
                          <th>Smoking_Habbits</th>
                          <th>Drinking_Habbits</th>
                          <th>Vehicles_Having</th>
                        </tr>
                      </thead>
                      <tbody>
                        <?php 
                          $query="select * from tbl_lifestyle";
                          $display= mysqli_query($conn, $query) or die(mysqli_error($conn));
                          while ($row=mysqli_fetch_array($display)){
                          ?>
                          <tr>
                            <td><?php echo $row['Lifestyle_ID'];?></td>
                            <td><?php echo $row['Member_Detail_ID'];?></td>
                            <td><?php echo $row['BloodGroup'];?></td>
                            <td><?php echo $row['Hobbies_Intrest'];?></td>
                            <td><?php echo $row['Member_Diet'];?></td>
                            <td><?php echo $row['Languages_Known'];?></td>
                            <td><?php echo $row['Residential_Status'];?></td>
                            <td><?php echo $row['Smoking_Habbits'];?></td>
                            <td><?php echo $row['Drinking_Habbits'];?></td>
                            <td><?php echo $row['Vehicles_Having'];?></td>
