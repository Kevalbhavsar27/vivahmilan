      ...
      <div class="content-wrapper">
        ...
        <?php 
              ...
              if(isset($_GET['ID']))
              {
                ...
                $ID=$_GET['ID'];
                $str="select * from tbl_community where  Community_ID =".$ID;
                $data=mysqli_query($conn,$str);
                $row=mysqli_fetch_array($data);
                $nm=$row['Community_Name'];
              }
              if(isset($_POST['submit']))
              {
                if(!empty($_GET['ID']))
                {
                  $str="update tbl_community set Community_Name='".$_POST['name']."' where Community_ID = ".$ID;
                ...
                {
                  $status=1;
                  $str="insert into tbl_community values(NULL,'".$_POST['name']."','".$status."')";
        ...
        <div class="content-body"><!-- Simple Validation start -->
            ...
            <div class="row">
                ...
                <div class="card">
                    ...
                    <h4 class="card-title">Community Add</h4>
                    </div>
                    <div class="card-body">
                     
                    <form id="jquery-val-form" method="post">
                        <div class="form-group">
                        <label class="form-label" for="basic-default-name">COMMUNITY_NAME</label>
                        <input
                            type="text"
                            class="form-control"
                            id="basic-default-name"
                            name="name"
                            placeholder="enter Community here"
                            value="<?php echo $nm?>"
                            required
                        />
                        </div>
