...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <title>Package Detail List | <?php echo $a?></title>
            ...
            <div class="breadcrumbs-top">
              ...
              <div class="breadcrumb-wrapper d-none d-sm-block">
                <ol class="breadcrumb p-0 mb-0 pl-1">
                  ...
                  <li class="breadcrumb-item"><a href="package_detail_list.php">Package Detail List</a>
                  </li>
                ...
                <div class="card-body card-dashboard">
                  ...
                  <div class="table-responsive">
                    <table class="table table-striped dataex-html5-selectors">
                      ...
                      <tbody>
                        <?php 
                          $query="select * from tbl_package_detail,tbl_package";
                          ...
                          <tr>
                            ...
                            <td>
                            <?php echo date("d-M-Y", strtotime($row['Package_Exp_Date']))?></td>
                            <td>
                            <span class="custom-control custom-switch">
                              <input type="checkbox" class="custom-control-input"
                              id="packageDetailSwitch_<?php echo $row['Package_Detail_ID']; ?>"
                              <?php if($row['Package_Detail_Status'] == '1') { echo 'checked'; } ?>
                              onclick="toggleStatus( <?php echo $row['Package_Detail_ID']; ?> )">
                              <label class="custom-control-label" for="packageDetailSwitch_<?php echo $row['Package_Detail_ID']; ?>"></label>
                            </span>
                            </td>
