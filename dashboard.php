...
<head>
    ...
    <title>Dashboard | <?php echo $a; ?></title>
                ...
                <div class="card text-center">
                  <div class="card-body">
                    <a href="community_list.php"><div class="badge-circle badge-circle-lg badge-circle-light-info mx-auto my-1">
                      <i class="bx bx-file fa fa-black-tie font-medium-5"></i>
                    </div>
                ...
                <div class="card text-center">
                  <div class="card-body">
                    <a href="subcommunity_list.php"><div class="badge-circle badge-circle-lg badge-circle-light-warning mx-auto my-1">
                      <i class="bx bx-detail fa fa-user font-medium-5"></i>
                    </div>
                ...
                <div class="card text-center">
                  <div class="card-body">
                    <a href="member.php"><div class="badge-circle badge-circle-lg badge-circle-light-success mx-auto my-1">
                      <i class="bx bx-user-plus fa fa-solid fa-question font-medium-5"></i>
                    </div>
                ...
                <div class="card text-center">
                  <div class="card-body">
                    <a href="language_list.php"><div class="badge-circle badge-circle-lg badge-circle-light-danger mx-auto my-1">
                      <i class="bx bx-globe fa fa-gift font-medium-5"></i>
                    </div>
                ...
                <div class="card text-center">
                  <div class="card-body">
                    <a href="tutor_subscription_detail.php"><div class="badge-circle badge-circle-lg badge-circle-light-danger mx-auto my-1">
                      <i class="bx bx-rupee fa fa-inr font-medium-5"></i>
                    </div>
                        ...
                        <table class="table table-hover">
                          ...
                          <tbody>
                            ...
                            <?php
                              ...
                              if ($result['Package_Name'] == "Silver") {
                                  echo "<b style='color:#ad9a9a;'>" . ucfirst($result['Package_Name']) . "</b>";
                              } elseif ($result['Package_Name'] == "Gold") {
                                  echo "<b style='color:gold;'>" . ucfirst($result['Package_Name']) . "</b>";
                              } elseif ($result['Package_Name'] == "Platinum") {
                                  echo "<b style='color:#8b8bec;'>" . ucfirst($result['Package_Name']) . "</b>";
                              } else {
                                  // Default styling for unknown package names
                                  echo "<b>" . ucfirst($result['Package_Name']) . "</b>";
                              }
                              ?>
